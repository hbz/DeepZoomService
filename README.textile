...
# Check in src/main/resources/conf/deepzoom.cfg that workingDir Property is set to absolute path to webapp directory (this bis needed to changed if you want to use a data dirextory outside of tomcat webapp
...
# Get with: git clone https://github.com/hbz/DeepZoomService.git
# Create web accessible temp and tilesCache directory outside tomcat's webapp directory. This directories must be accessible by tomcat-user
