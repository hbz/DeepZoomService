...
<body>
	<div class="header">
		...
		<p>
			Service-Provider URL used by Example Page:<br /> <em><%=Configuration.properties.getProperty("serviceUrl")%></em>
		</p>
	</div>
				...
				<table>
					<tr>
						<td align='center'><a class="dz_image_url"
							href="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/sagrada_portal.png">
								<img
								src="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/thumbs/sagrada_portal.png.jpg"
								width="140" height="105" alt="thumbs/sagrada_portal.png.jpg" />
						</a>
							<div>Northern Portal of Sagrada Familia in Barcelona</div>
							<div>(Original <a target="_blank" href="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/sagrada_portal.png" >image</a> has size of 15.6 MB)</div></td>
						<td align='center'><a class="dz_image_url"
							href="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/sagrada.jpg">
								<img
								src="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/thumbs/sagrada.jpg.jpg"
								width="140" height="105" alt="thumbs/sagrada_portal.JPG.jpg" />
						</a>
							<div>Sagrada Familia in Barcelona</div>
							<div>(Original <a target="_blank" href="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/sagrada.jpg" >image</a> has size of 4.7MB)</div></td>
					</tr>
				</table>
			</div>
		</div>
			...
			<div>
				<ul>
					<li class="dz_image_url"
						img_url="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/sagrada_portal.png">
						Nordportal (?) der Sagrada Familia</li>
					<li class="dz_image_url"
						img_url="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/sagrada.jpg">
						Sagrada Familia</li>
					<li class="dz_image_url"
						img_url="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/sagrada.jpg">
						Sagrada Familia von Innen</li>
					<li class="dz_image_url"
						img_url="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/Pfingststrum.JPG">
						Pfingststurm in Bochum</li>
					<li class="dz_image_url"
						img_url="<%=Configuration.properties.getProperty("serviceUrl")%>/example_img/Bambusgarten.png">
...
var imageUrl = "<%=Configuration.properties.getProperty("serviceUrl")%>/opensd/ruhrinfrastruktur.png";
var viewer = null;
