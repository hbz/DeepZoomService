...
public class TestDziResult {
	...
	private static Logger log = Logger.getLogger(TestDziResult.class);
		...
		public void getDziResult(){
			...
			File dziFile=new File(Globals.conf.getResultDirPath()+"/"+Globals.createFileName(url.getPath())+".dzi");
			File filesDir=new File(Globals.conf.getResultDirPath()+"/"+Globals.createFileName(url.getPath())+"_files");
